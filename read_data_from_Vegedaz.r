...
read.vegedaz.data <- function(path){
	# Prepare Artlist
	con <- file(paste(path,"Artlist.txt", sep=""), encoding = "windows-1252" )
	...
	con <- file(paste(path,"FloInd.txt", sep=""), encoding = "windows-1252" )
	...
	con <- file(paste(path,"ZeiLan.txt", sep=""), encoding = "windows-1252" )
	...
	return(list(indicativa=indicativa, landolt=landolt))
